...
import { SponsorGoldStyled } from './styled'
...
const SponsorGold: React.FC<Props> = ({ sponsor, itemSize, templateData }) => {
          ...
          {Number(itemSize) === 1 && (
            <div className='four-class'>
              ...
              <div className='company-money-small'>
                <div className='money-small'>{`${fund?.toLocaleString('en-US') || 0} ${t('CIRCLE')}`}</div>
              </div>
