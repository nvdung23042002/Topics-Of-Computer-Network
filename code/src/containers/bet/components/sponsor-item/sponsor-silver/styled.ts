...
export const SponsorSilverStyled = styled.div`
  width: 100%;
  max-width: 740px;
  height: 130px;
  ...
  .four-class {
    ...
    background-image: repeating-linear-gradient(0deg, transparent, transparent 8px, transparent 8px, transparent 20px),
      repeating-linear-gradient(90deg, #929294, #929294 8px, transparent 8px, transparent 20px),
      repeating-linear-gradient(180deg, transparent, transparent 8px, transparent 8px, transparent 20px),
      repeating-linear-gradient(270deg, #929294, #929294 8px, transparent 8px, transparent 20px) // bottom
;
    border-image: repeating-linear-gradient(0deg, #929294, #929294 8px, transparent 8px, transparent 20px);
  }
