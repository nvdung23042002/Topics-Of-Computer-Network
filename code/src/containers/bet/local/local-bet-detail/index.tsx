...
import { Divider, Form, Spin, Tooltip } from 'antd'
...
const LocalBetDetail: React.FC = () => {
  ...
  const getMatchDetail = useCallback(async () => {
    try {
      ...
      const response = await NSBService.getMatchDetail({ matchId, langKey })
